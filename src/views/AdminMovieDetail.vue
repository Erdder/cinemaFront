<template>
  ...
  <Card style="width:1000px; margin-bottom: 20px">
    ...
    <div style="text-align:left;float: left; width: 100px;height: 130px; margin-right: 5px; margin-top: 5px">
    ...
    <Modal
      ...
      <Form v-model="movieDetail" :rules="ruleValidate" :label-width="70"
        ...
        <FormItem label="电影导演" style="width: 300px">
          <Input v-model="movieDetail.director" placeholder="请输入导演名字"
          ></Input>
        </FormItem>
        ...
        <FormItem label="剧情介绍">
          <Input v-model="movieDetail.description" type="textarea" :autosize="{minRows: 2,maxRows: 5}"
                 placeholder=""></Input>
        </FormItem>
      </Form>
    </Modal>
