      ...
      <Layout :style="{padding: '0 50px'}">
        <Content :style="{padding: '24px 0', minHeight: '280px', background: '#fff'}">
          <Layout>
            ...
            <Content :style="{padding: '24px 40px', minHeight: '280px', background: '#fff'}">
              <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="70"
                    style="width: 500px">
                <FormItem label="电影名称" prop="name" style="width: 300px">
                  <Input v-model="formValidate.name" placeholder="" ></Input>
                </FormItem>
                <FormItem label="yingt " prop="ID" style="width: 300px">
                ...
                <FormItem label="语言" prop="language" style="width: 300px">
                ...
                <FormItem label="时长" prop="duration" style="width: 300px">
                  <Input v-model="formValidate.duration" placeholder="请输入数字">
                    <span slot="append">分钟</span>
                  </Input>
                </FormItem>
                <FormItem label="上映日期" style="width: 530px">
                  <Row>
                    <Col span="5">
                      <FormItem prop="date">
                ...
                <FormItem label="总导演" prop="nameOfDir" style="width: 300px">
                  <Input v-model="formValidate.nameOfDir" placeholder="请输入总导演名字"
                  ></Input>
                </FormItem>
